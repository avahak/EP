    ...
    return (
        <Box sx={{minHeight: "700px", minWidth: "217px", overflow: "hidden", background: "#e1faed"}}>
            ...
            <map name="linkkikartta">
                ...
                <area alt="Ohjelma" shape="rect" coords="0,164,190,180" href={`${url}`+"Ohjelma_nyt.php"}/>
                ...
                <area alt="Kilpailukaavio" shape="rect" coords="0,373,190,395" href={`${url}`+"Kilpailukaavio25.php"}/>
